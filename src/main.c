...
int main(void)
{
	...
	femDiffusionProblem* theProblemX = femDiffusionCreate("../data/meca1120-projet-meshMedium.txt", FEM_BAND, FEM_YNUM);
	femDiffusionProblem* theProblemY = femDiffusionCreate("../data/meca1120-projet-meshMedium.txt", FEM_BAND, FEM_YNUM);
  ...
  //
			...
			theProblemX = femDiffusionCreate("../data/meca1120-projet-meshMedium.txt", FEM_BAND, FEM_YNUM);
			theProblemY = femDiffusionCreate("../data/meca1120-projet-meshMedium.txt", FEM_BAND, FEM_YNUM);
			theProblem = femDiffusionCreate("../data/meca1120-projet-meshMedium.txt", FEM_BAND, FEM_YNUM);
